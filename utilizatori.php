             ...
             <?php if($useri): ?>
              <?php while($row = $useri->fetch_assoc()):?>
                    ...
                    <div class="col-md-3"><font size="4">
                        <form method="POST">
                            <button class="btn btn-danger" type="submit" formaction="admin/sterge_utilizator.php?user=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-remove"> </span> Sterge</button>
