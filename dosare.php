    ...
    <?php if ($_SESSION['tip'] == 2):?>
     <div class="col-md-12">
        ...
        <div class="row" id="rand">
                <div class="col-md-3"><strong>Numar dosar</strong></div>
                <div class="col-md-3"><strong>Nume</strong></div>
                <div class="col-md-3"><strong>CNP</strong></div>
        ...
        <div class="row">
            ...
            <div class="col-md-3"><input type="text" name="numar" required/> </div>
            <div class="col-md-3"><input type="text" name="nume" required/> </div> 
            <div class="col-md-3"><input type="text" name="cnp" required/> </div>
